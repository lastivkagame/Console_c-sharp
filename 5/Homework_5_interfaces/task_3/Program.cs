...
Доповнити один(!) з створених раніше класів(Student, Department чи ін.) реалізацією інтерфейсу IEnumerable.
    o для  класу Student при використанні foreach-ом повинен проходитися рваний масив з оцінок 
 -> o для класу Department при використанні  foreach повинен проходитися масив(чи список) з працівників <-
 my choose(бо треба тільки тільки одне з двох)*/
